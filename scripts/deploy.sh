...
if [[ ${GITHUB_TOKEN} ]]  && [[ ${GITEE_TOKEN} ]]; then
    ...
    git push --force --quiet "https://dunwu:${GITHUB_TOKEN}@github.com/dunwu/javatech.git" gh-pages
    git push --force --quiet "https://turnon:${GITEE_TOKEN}@gitee.com/turnon/javatech.git" gh-pages
else
    echo "使用 ssh 公钥部署 gh-pages"
    git push -f git@github.com:dunwu/javatech.git gh-pages
