...
- [6. 多级缓存](#6-多级缓存)
    - [6.1. 使用进程缓存](#61-使用进程缓存)
    - [6.2. 使用多级缓存](#62-使用多级缓存)
- [7. 缓存问题](#7-缓存问题)
    - [7.1. 缓存雪崩](#71-缓存雪崩)
    - [7.2. 缓存穿透](#72-缓存穿透)
    - [7.3. 缓存击穿](#73-缓存击穿)
...
![img](https://user-gold-cdn.xitu.io/2018/8/21/1655c597d9001318?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![img](https://user-gold-cdn.xitu.io/2018/7/30/164e946ff882653a?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![img](https://user-gold-cdn.xitu.io/2018/8/21/1655d35701c24b7f?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![img](https://user-gold-cdn.xitu.io/2018/8/22/1655d50555645a36?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
