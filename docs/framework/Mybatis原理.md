...
- [2. Mybatis 生命周期](#2-mybatis-生命周期)
  ...
  - [2.4. 映射器](#24-映射器)
- [3. Mybatis 的架构](#3-mybatis-的架构)
  - [3.1. 配置层](#31-配置层)
  - [3.2. 接口层](#32-接口层)
  - [3.3. 数据处理层](#33-数据处理层)
  - [3.4. 框架支撑层](#34-框架支撑层)
- [4. SqlSession 内部工作机制](#4-sqlsession-内部工作机制)
  - [4.1. SqlSession 子组件](#41-sqlsession-子组件)
  - [4.2. SqlSession 和 Mapper](#42-sqlsession-和-mapper)
  - [4.3. SqlSession 和 Executor](#43-sqlsession-和-executor)
  - [4.4. Executor 工作流程](#44-executor-工作流程)
  - [4.5. StatementHandler 工作流程](#45-statementhandler-工作流程)
  - [4.6. ParameterHandler 工作流程](#46-parameterhandler-工作流程)
  - [4.7. ResultSetHandler 工作流程](#47-resultsethandler-工作流程)
- [5. 参考资料](#5-参考资料)
